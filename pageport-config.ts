export default {
  ...
  theme: {
    defaultData: {
      ...
      primary_font_family:
        'Roboto,"Open Sans","Source Sans Pro",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol"',
  ...
  dataProtection: {
    trackers: [
      {
        type: 'pageport control',
        purpose: 'Speichert die Datenschutzeinstellungen der Besucher, so wie sie von diesen ausgewählt wurden.',
        provider: 'Seedbox Ventures GmbH',
        category: 'Essential',
      },
    ],
  },
